...
type SonataFlowPlatformSpec struct {
	...
	// Eventing defines a broker as the default broker when the workflow, Dataindex, or Jobservice does not have a sink or source specified.
	// +optional
...
// PlatformEventingSpec specifies the broker to be used as the default sink or source
// +k8s:openapi-gen=true
