...
func Test_OverrideStartupProbe(t *testing.T) {
	...
	devReconciler := NewProfileReconciler(context.TODO(), client, &rest.Config{}, test.NewFakeRecorder())
...
func Test_recoverFromFailureNoDeployment(t *testing.T) {
	...
	reconciler := NewProfileReconciler(context.TODO(), client, &rest.Config{}, test.NewFakeRecorder())
